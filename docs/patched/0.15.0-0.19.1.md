...
Spiraling is similar to [rocketing](../clipping/#rocket--piggy), but it’s slower and more maneuverable. It’s performed in the same way as a Rocket, but one player offers to hold hands while the other asks for a piggyback. Both players will go through collision boxes. Simply let go of the other player to stop the launch.

{: .note }
> Clouds and other winds are not [collision boxes](../terms-and-methods/#collision-boxes) and can sometimes stand in your way!

{: .highlight }
> For most players, this is enough. If you'd like to learn more about fine tuning your spirals, head to the [advanced](../advanced/#advanced-spiraling) section.
...
1. Start recording.
1. Go home or through a different [loading zone](../../terms-and-methods/#reset-walls-and-loading-zones).
1. As you white out, stop recording.
...
Sideways [rockets](../../clipping/#rocket--piggy), as you can imagine, can be rather useful for OOBing. This is a specialized version of a sideways rocket that shoots you out in a desired direction and then up. This trick is not used all that often, but it has its moments in the sun.

1. Place your table on any vertical surface.
1. Both players sit at the sideways table.
1. Stay on the table, but both players prepare for a [rocket](../../clipping/#rocket--piggy) by asking to piggyback. Be careful not to start following your friend by accident.
...
Sky progressed from version 0.14.5 to 0.19.1 while version one of the Sky OOB Guide stopped being updated to when version two launched.